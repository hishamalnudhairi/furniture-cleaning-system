    ...
    <div class="flex min-h-screen flex-col items-center justify-center px-4 py-10">
        ...
        <div class="mb-8 flex items-center gap-2 text-sm">
            ...
            <a href="{{ route('lang.switch', 'ar') }}"
               class="rounded-md px-3 py-1 transition {{ app()->getLocale() === 'ar' ? 'bg-teal-600 text-white' : 'bg-white text-slate-600 ring-1 ring-slate-200 hover:bg-slate-100' }}">
                {{ __('Arabic') }}
            </a>
            <a href="{{ route('lang.switch', 'en') }}"
               class="rounded-md px-3 py-1 transition {{ app()->getLocale() === 'en' ? 'bg-teal-600 text-white' : 'bg-white text-slate-600 ring-1 ring-slate-200 hover:bg-slate-100' }}">
                {{ __('English') }}
            </a>
        </div>
        ...
        <div class="w-full max-w-xl rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
            <div class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-teal-100">
            ...
            <p class="mb-1 text-lg font-medium text-teal-700">
