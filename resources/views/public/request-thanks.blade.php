...
@section('content')
    <div class="mx-auto mt-10 max-w-md rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
        <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-teal-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 text-teal-600" fill="none"
        ...
        <div class="mb-6 rounded-xl bg-slate-50 p-4 ring-1 ring-slate-100">
            ...
            <p class="mt-1 text-2xl font-bold tracking-wider text-teal-700">{{ $requestNumber }}</p>
        </div>

        <a href="{{ route('request-service.create') }}"
           class="inline-block rounded-lg bg-teal-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-teal-700">
